    ...
    <footer className="bg-gray-950 text-white py-12 relative overflow-hidden">
      ...
      <div className="content-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-[#6E3FC9] to-[#FF8A4C] hover:scale-105 transition-transform">Servify</h3>
            <p className="text-gray-400 mb-4">
              Modern solutions for service-based businesses.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-[#FF8A4C] transition-colors duration-300 hover:scale-105 transition-transform">
